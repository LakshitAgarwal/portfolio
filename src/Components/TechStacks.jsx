    ...
    <div className="py-28 w-fit mx-auto" ref={ref}>
      ...
      <div className="flex gap-7 mb-8 w-fit mx-auto">
        <motion.div
          ...
          animate="animate"
        >
          <img src="/figma-184a11e6.png" className="w-12" alt="" />
        </motion.div>
        <motion.div variants={variants(3)} initial="initial" animate="animate">
          <img src="/mongodb-54000b2b.png" className="w-12" alt="" />
        </motion.div>
        <motion.div
          ...
          animate="animate"
        >
          <img src="/download-(1).png" className="w-12" alt="" />
        </motion.div>
        <motion.div variants={variants(4)} initial="initial" animate="animate">
          <img src="/nodejs-d83eb6dd.png" className="w-12" alt="" />
        </motion.div>
        <motion.div
          ...
          animate="animate"
        >
          <img src="/framer.png" className="w-12" alt="" />
        </motion.div>
        <motion.div variants={variants(5)} initial="initial" animate="animate">
          <img src="/images.webp" className="w-12" alt="" />
        </motion.div>
        <motion.div
          ...
          animate="animate"
        >
          <img src="/ts.png" className="w-12" alt="" />
        </motion.div>
      </div>

      {/* Second set of images */}
      <div className="flex gap-5 mb-3 w-fit mx-auto">
        <motion.div
          variants={variants(2.5)}
          initial="initial"
          animate="animate"
        >
          <img src="/html-92b76a73.png" className="w-12" alt="" />
        </motion.div>
        <motion.div variants={variants(3)} initial="initial" animate="animate">
          <img src="/css-79a7f026.png" className="w-12" alt="" />
        </motion.div>
        <motion.div
          variants={variants(3.5)}
          initial="initial"
          animate="animate"
        >
          <img src="/download.png" className="w-12" alt="" />
        </motion.div>
        <motion.div variants={variants(3)} initial="initial" animate="animate">
          <img src="/reactjs-966214a8.png" className="w-12" alt="" />
        </motion.div>
        <motion.div
          variants={variants(2.5)}
          initial="initial"
          animate="animate"
        >
          <img src="/redux-171787ca.png" className="w-12" alt="" />
        </motion.div>
        <motion.div variants={variants(2)} initial="initial" animate="animate">
          <img src="/tailwind-6ece120d.png" className="w-12" alt="" />
        </motion.div>
      </div>
